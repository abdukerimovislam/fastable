        ...
        Expanded(
          ...
          child: BlocBuilder<WaterBloc, WaterState>(
            builder: (context, waterState) {
              ...
              return GlassCard(
                onTap: () =>
                    _showDrinkPicker(context, soundService, fastingState),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "/ ${waterState.dailyGoal} ${l10n.unitMl}",
                            style: TextStyle(
              ...
              children: [
                ...
                Expanded(
                  child: TextButton(
                    ...
                    child: Text(
                      l10n.waterConfirmDrinkBreakFast,
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      if (drink.breaksFast &&
                          fastingState.phase == FastingPhase.fasting) {
                        final confirmed = await _showBreakFastWarning(
                          context,
                          drink,
                        );
                        if (confirmed != true) {
                      ...
                      if (context.mounted) {
                        context.read<WaterBloc>().add(
                          AddDrink(type: drink, volumeMl: 250),
                        );
                        Navigator.pop(ctx);
                            ...
                            SnackBar(
                              content: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      l10n.waterFastStoppedByDrink(
                                        drink.localizedName(l10n),
                                      ),
                                      style: const TextStyle(
...
class _WeightPickerSheetState extends State<_WeightPickerSheet> {
  ...
  final List<double> _weights = List.generate(
    2700,
