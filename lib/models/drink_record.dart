...
enum DrinkCategory { water, coffee, tea, soda, juice, alcohol, other }
...
class DrinkType {
  ...
  final Color color;
  final double
  hydrationFactor; // 1.0 = чистая вода, 0.8 = кофе (мочегонное), -1.0 = алкоголь (обезвоживает)
  ...
  String localizedName(AppLocalizations l10n) {
    switch (name) {
      ...
      case 'Black Coffee':
        return l10n.drinkBlackCoffee;
      case 'Latte / Sweet Coffee':
        return l10n.drinkLatteSweetCoffee;
      case 'Green/Black Tea':
        return l10n.drinkGreenBlackTea;
      case 'Diet Soda':
        return l10n.drinkDietSoda;
      case 'Sweet Soda':
        return l10n.drinkSweetSoda;
      case 'Juice':
        return l10n.drinkJuice;
      case 'Alcohol':
        return l10n.drinkAlcohol;
      default:
        return name;
    }
  }
  ...
  static const List<DrinkType> allTypes = [
    ...
    DrinkType(
      category: DrinkCategory.coffee,
      name: "Latte / Sweet Coffee",
      icon: Icons.local_cafe_rounded,
      color: Colors.orangeAccent,
      hydrationFactor: 0.6,
      breaksFast: true,
    ), // С молоком/сахаром - прерывает
    DrinkType(
...
class DrinkRecord {
  ...
  DrinkRecord({required this.time, required this.volumeMl, required this.type});
  ...
  factory DrinkRecord.fromJson(Map<String, dynamic> json) {
    ...
    DrinkType type = DrinkType.allTypes.firstWhere(
      (d) =>
          ...
          (drinkName == null || d.name == drinkName),
